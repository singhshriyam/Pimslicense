...
export const validationpixelstrapTheme = ['Crocs', 'Tivo', 'Wingo']
...
export const pixelstrapThemeList = ['Tivo', 'Crocs', 'Roxo', 'Oslo', 'Voxo', 'Sheltos', 'Petkart', 'Zeta'];
export const pixelstrapRaisetList = ['Tivo', 'Roxo', 'Wingo', 'Crocs', 'Koho'];
...
export const inputGroupPixelstrapList = ['Tivo', 'Crocs', 'Roxo']
