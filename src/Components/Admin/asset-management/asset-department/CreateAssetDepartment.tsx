...
const AssetDepartmentSchema = Yup.object({
...
if (result.isConfirmed) {
  ...
  const { values, handleBlur, handleChange, handleSubmit, errors, touched } =
    useFormik({
      initialValues,
      validationSchema: AssetDepartmentSchema,
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="form-group">
                  <label htmlFor="">Asset Department Name <span className="text-danger">*</span></label>
                  <input
            ...
            <CardHeader>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <Badge color="danger" className="fs-6">
                  {assetStates.length} Asset Department
                </Badge>
              </div>
            </CardHeader>
            <CardBody>
              {assetStates.length > 0 ? (
                    ...
                    <tbody>
                      {assetStates.map((state:any) => (
                        <tr key={state.id}>
                          ...
                          href={`/admin/asset-department/${state.id}`}
                        >
                         ✎
                        </Link>
                              <Button
                ...
                <div className="text-center py-5">
                  <p className="text-muted mb-0">No asset department</p>
