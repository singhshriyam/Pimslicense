...
const SiteTypeSchema = Yup.object({
...
if (result.isConfirmed) {
    try {
      ...
      const filterSiteTypes = siteTypes.filter((siteType: any) => siteType.id !== id);
      setSiteTypes(filterSiteTypes);
    } catch (error) {}
  }
  });
  ...
  const { values, handleBlur, handleChange, handleSubmit, errors, touched } =
    useFormik({
      initialValues,
      validationSchema: SiteTypeSchema,
          ...
          if (response.status === 200) {
           getSiteTypes();
            ...
            Swal.fire({
              icon: "success",
              title: "Success!",
              text: "Site Type Created Successfully!",
            });
          }
        } catch (error: any) {
