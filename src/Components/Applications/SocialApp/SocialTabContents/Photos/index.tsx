                            ...
                            <Gallery withCaption>
                                {socialPhotosData.map((item) => (
                                    <Col xl={3} sm={6} className='box-col-33' key={item.id}>
                                        <figure>
                                            <Item original={`${ImagePath}/big-lightgallry/${item.image}`} width={819} height={486} caption="is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy. Copyright 2024 © Crocs theme by pixelstrap.">
                                                {({ ref, open }) => (
