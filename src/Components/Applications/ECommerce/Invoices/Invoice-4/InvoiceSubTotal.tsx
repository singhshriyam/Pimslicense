  ...
  return (
    <ul style={{ padding: 0, margin: 0, listStyle: "none" }} className="simple-list">
      <li style={{ display: "flex", paddingBottom: 16 }}>
        ...
        <span style={{ display: "block", width: 95, color: "#5C61F2", opacity: "0.9", fontWeight: 600 }} >
          $6100.00
        </span>
      </li>
      <li style={{ display: "flex", paddingBottom: 16 }}>
      ...
      <li style={{ display: "flex", alignItems: "center" }}>
        ...
        <span style={{ display: "block",color: "#5C61F2", opacity: "0.9", fontWeight: 600, padding: "12px 25px", borderRadius: 5, background: "#F5F6F9", fontSize: 18}} >
          $6120.00
        </span>
      </li>
    </ul>
