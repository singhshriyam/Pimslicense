...
const InvoiceRightSide = () => {
  return (
    <ul style={{ listStyle: "none", display: "flex", background: "linear-gradient(291deg, #5C61F2 21.2%, #6051FE 83.92%)", padding: "31px 80px", borderBottomLeftRadius: 100, gap: 28 }} className="flex-row simple-list" >
