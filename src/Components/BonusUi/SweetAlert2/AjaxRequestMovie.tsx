...
const AjaxRequestMovie = () => {
  const displayAlert = () => {
    SweetAlert.fire({ text: 'Search for a movie. e.g. "Harry Potter".', input: "text", confirmButtonColor: "#5C61F2", })
      .then((name) => {
      ...
      .then((json) => {
        ...
        if (!movie) return SweetAlert.fire({ text: "No movie was found!", confirmButtonColor: "#5C61F2" });
